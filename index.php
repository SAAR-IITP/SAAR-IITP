                    ...
                    <div class="row pad-3">
                        ...
                        <div class="col-6 img">
                            <center><img src="asset/img/contact.png">
                                ...
                                <a href="" onclick="return contactUs()">CONTACT US</a></center>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 img">
                            <center><img src="asset/img/help-icon.png">
                                <a href="" onclick="return show_pop()">HELP US GROW</a> </center>
                        </div>
            ...
            <div id="myModal">
                <div class="mymodal-content">
                    ...
                    <div class="div-content">
                        ...
                        <div class="div-right"><h1>SignUp Here</h1><br>
                            <h4>If you don't have an account.<br>
                                <button class="submit pad-2"><a href='signup.php?type=normal' id='sign-up'>SignUp</a></button><br>
                                <button class="submit pad-2" style="background-color:#3B579D; background-image: none;"><a href='signup.php?type=normal' id='sign-up' style="color:#fff !important;font-size: 15px;">SignUp with Facebook</a></button>
                            </h4>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
                    ...
                    <div id="alumni-needs">
                        ...
                        <div class="alumni-needs-container">
                            <center>
                                ...
                                <div class="post-need"><button onclick="show_form()">LOGIN/SIGNUP</button></div>
                            </center>
                        </div>
                    </div>
                </div>
        ...
        <div class=" contact-form" id="contact_form" style="display:none;">
            <div class="myclose" id="close" onclick="close_modal()">&times;</div>
            <div class="row">
